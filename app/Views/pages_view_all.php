        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    <h2> List Halaman </h2>   
                    <a href="<?= base_url('https://belajar-ci.test/admin/pages/create')?>" class="btn btn-primary mb-2">Add halaman</a>
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <table class="table table-striped" id="tableuser">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('https://belajar-ci.test/admin/pages/edit/'.$pengguna['id']);?>" class="btn btn-primary">Edit</a>
                                            <a href="<?= base_url('https://belajar-ci.test/admin/pages/delete/'.$pengguna['id']);?>" class="btn btn-warning">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
