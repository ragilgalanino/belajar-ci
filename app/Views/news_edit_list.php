            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            <h2>Edit Berita</h2>
                            <form action="<?= base_url('https://belajar-ci.test/admin/news/update'); ?>" method="POST">
                                <input type="hidden" name="id" value="<?= $list['id'] ?>">
                                <div class="form-grup">
                                    <label for="judul">Judul Berita</label>
                                    <br>
                                    <input type="text" name="judulberita" class="form-control" id="judulberita" placeholder="Masukkan Nama"
                                    value="<?= $list['judulberita'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                 ...
                                 <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="isiberita" class="form-control" id="isiberita" placeholder="Masukkan Isi Berita"
                                    value="<?= $list['isiberita'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    <button type="submit" id="send_form" class="btn btn-primary">Submit</button>
                                    <a href="<?= base_url('https://belajar-ci.test/admin/news/list')?>" class="btn btn-warning">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
