            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            <h3>Add Halaman</h3>
                            <form action="<?= base_url('https://belajar-ci.test/admin/pages/store'); ?>" method="POST">
                                <div class="form-grup">
                                    <label for="judul">Judul Halaman</label>
                                    <br>
                                    <input type="text" name="judulhalaman" class="form-control" id="judulhalaman" placeholder="Masukkan Judul Halaman">
                                    <br>
                                </div>
                                <div class="form-grup">
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="isihalaman" class="form-control" id="isihalaman" placeholder="Masukkan Isi Halaman">
                                    <br>
                                </div>
