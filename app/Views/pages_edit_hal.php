            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            <h2>Edit pages</h2>
                            <form action="<?= base_url('https://belajar-ci.test/admin/pages/update'); ?>" method="POST">
                                <input type="hidden" name="id" value="<?= $hal['id'] ?>">
                                <div class="form-grup">
                                    <label for="judul">Judul Halaman</label>
                                    <br>
                                    <input type="text" name="judulhalaman" class="form-control" id="judulhalaman" placeholder="Masukkan Nama"
                                    value="<?= $hal['judulhalaman'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                 ...
                                 <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="isihalaman" class="form-control" id="isihalaman" placeholder="Masukkan Halaman"
                                    value="<?= $hal['isihalaman'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    <button type="submit" id="send_form" class="btn btn-success">Submit</button>
                                    <a href="<?= base_url('https://belajar-ci.test/admin/pages/hal')?>" class="btn btn-danger">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
